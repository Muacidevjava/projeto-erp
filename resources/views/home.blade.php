    ...
    <div class="rows">
        ...
        <div class="col-12">
            <div class="rows contas">
                ...
                <div class="col-6 mb-4 d-flex">
                    <div class="caixa-home conta-receber hoje w-100">
                        <svg width="50" viewBox="0 0 64 70" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col mb-4 d-flex">
                    <div class="caixa-home conta-receber hoje w-100">
                        <svg width="50" viewBox="0 0 66 76" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col mb-4 d-flex">
                    <div class="caixa-home conta-receber hoje w-100">
                        <svg width="50" viewBox="0 0 35 28" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col mb-4 d-flex">
                    <div class="caixa-home conta-receber hoje w-100">
                        <svg width="70" viewBox="0 0 41 30" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
