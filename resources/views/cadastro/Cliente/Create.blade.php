                        ...
                        <fieldset>
                            ...
                            <div class="rows center-middle">
                                ...
                                <div class="col-3 mt-4 mb-3">
                                    <input type="button" onclick="buscarCNPJ()" value="Pesquisar CNPJ" class="width-100 btn btn-roxo d-block m-auto">
                                </div>
                            </div>
                        </fieldset>
                    </div>
                        ...
                        <div class="p-2">
                            ...
                            <div class="rows">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="nome_razao_social" id="nome_razao_social" required value="{{ old('nome_razao_social') }}" class="form-campo">
                                </div>
                                <div class="col-6 mb-3" id="divFantasia">
                                    <label class="text-label">Nome Fantasia</label>
                                    <input type="text" name="nome_fantasia" id="nome_fantasia" value="{{ old('nome_fantasia') }}" class="form-campo">
                                </div>
                                <div class="col-4 mb-3">
                                    <label class="text-label" id="lblCnpj">CNPJ<span class="text-vermelho">*</span></label>
                                    <input type="text" name="cpf_cnpj" id="cnpj" value="{{ old('cpf_cnpj') }}" class="form-campo">
                                </div>
                                <div class="col-3" id="div_tipo_contribuinte">
                                    ...
                                    <select class="form-campo" name="tipo_contribuinte" id="tipo_contribuinte">
                                        <option value="1" {{ old('tipo_contribuinte') == '1' ? 'selected' : '' }}>1 - Contribuinte ICMS</option>
                                        <option value="9" {{ old('tipo_contribuinte') == '9' ? 'selected' : '' }}>9 - Não Contribuinte</option>
                                        <option value="2" {{ old('tipo_contribuinte') == '2' ? 'selected' : '' }}>2 - Contribuinte Isento</option>
                                    </select>
                                </div>
                                <div class="col-3 mb-3">
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <input type="text" name="rg_ie" maxlength="14" id="rg_ie" value="{{ old('rg_ie') }}" class="form-campo">
                                </div>
                                <div class="col-4 mb-3">
                        ...
                        <div class="p-2">
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    ...
                                    <input type="text" value="{{ old('cep') }}" name="cep" id="cep" class="form-campo busca_cep mascara-cep">
                                </div>
                                <div class="col-6 mb-3">
                                    <label class="text-label">Logradouro</label>
                                    <input type="text" name="logradouro" id="logradouro" value="{{ old('logradouro') }}" class="form-campo rua">
                                </div>
                                <div class="col-2 mb-4">
                                    <label class="text-label">Numero</label>
                                    <input type="text" name="numero" id="numero" value="{{ old('numero') }}" class="form-campo ">
                                </div>
                                <div class="col-2 mb-2">
                                    <label class="text-label">UF</label>
                                    <input type="text" name="uf" id="uf" value="{{ old('uf') }}" class="form-campo estado">
                                </div>
                                <div class="col-3 mb-3">
                                    <label class="text-label">Complemento</label>
                                    <input type="text" name="complemento" id="complemento" value="{{ old('complemento') }}" class="form-campo">
                                </div>
                                <div class="col-3 mb-3">
                                    <label class="text-label">Bairro</label>
                                    <input type="text" name="bairro" id="bairro" value="{{ old('bairro') }}" class="form-campo bairro">
                                </div>
                                <div class="col-4 mb-2">
                                    <label class="text-label">Cidade</label>
                                    <input type="text" name="cidade" id="cidade" value="{{ old('cidade') }}" class="form-campo cidade">
                                </div>
                                <div class="col-2 mb-2">
                                    <label class="text-label">IBGE</label>
                                    <input type="text" name="ibge" id="ibge" value="{{ old('ibge') }}" class="form-campo ibge">
                                </div>
                            </div>
                        </div>
                    </div>
