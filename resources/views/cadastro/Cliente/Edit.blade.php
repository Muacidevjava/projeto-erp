                            ...
                            <div class="rows">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="nome_razao_social" id="nome_razao_social" required
                                        value="{{ old('nome_razao_social', $cliente->nome_razao_social) }}" class="form-campo">
                                </div>
                                <div class="col-6 mb-3" id="divFantasia">
                                    <label class="text-label">Nome Fantasia</label>
                                    <input type="text" name="nome_fantasia" id="nome_fantasia"
                                        value="{{ old('nome_fantasia', $cliente->nome_fantasia) }}" class="form-campo">
                                </div>
                                ...
                                <div class="col-3" id="div_tipo_contribuinte">
                                    ...
                                    <select class="form-campo" name="tipo_contribuinte" id="tipo_contribuinte">
                                        <option value="1" {{ old('tipo_contribuinte', $cliente->tipo_contribuinte) == '1' ? 'selected' : '' }}>1 - Contribuinte ICMS</option>
                                        <option value="9" {{ old('tipo_contribuinte', $cliente->tipo_contribuinte) == '9' ? 'selected' : '' }}>9 - Não Contribuinte</option>
                                        <option value="2" {{ old('tipo_contribuinte', $cliente->tipo_contribuinte) == '2' ? 'selected' : '' }}>2 - Contribuinte Isento</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <select name="indFinal" id="indFinal" class="form-campo">
                                        <option value="0" {{ old('indFinal', $cliente->indFinal) == '0' ? 'selected' : '' }}>Não</option>
                                        <option value="1" {{ old('indFinal', $cliente->indFinal) == '1' ? 'selected' : '' }}>Sim</option>
                                    </select>
                                </div>
                
                                <div class="col-2 mb-3" id="divIscEstadual">
                                ...
                                <div class="col-8 mb-3">
                                    ...
                                    <input type="text" name="email" value="{{ old('email', $cliente->email) }}" class="form-campo">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-2">
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    ...
                                    <input type="text" value="{{ old('cep', $cliente->cep) }}" name="cep" id="cep"
                                ...
                                <div class="col-2 mb-2">
                                    ...
                                    <input type="text" name="uf" id="uf" value="{{ old('uf', $cliente->uf) }}" class="form-campo estado">
                                </div>
                                <div class="col-3 mb-3">
