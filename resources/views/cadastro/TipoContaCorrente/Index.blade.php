    ...
    <div class="col-12">
        ...
        <div class="caixa">
            ...
            <div class="px-2 py-2 w-100 d-grid">
                                            <form action="tipocontacorrente" method="POST">
                                    <input type="hidden" name="_token" value="tvtnp2mVXd8pddzy2IANE1RBBXPKhRKrJNRg7Ttx">                    <div
                    class="caixafield  p-2 radius-4 border">
