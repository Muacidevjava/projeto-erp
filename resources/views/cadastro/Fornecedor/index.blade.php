        ...
        <div class="caixa">
            ...
            <div class="px-2 py-2 w-100 d-grid">
                <div class="d-flex text-end">
                    <a href="fornecedor/create" class="btn btn-roxo mx-1" title="Adicionar novo"><i
                    ...
                    <tbody>
                                ...
                                <td align="center">
                                    ...
                                    <a href="javascript:;"
                                        ...
                                        <form action="fornecedor/1" method="POST"
                                            id="apagar1">
                                            <input type="hidden" name="_method" value="delete">                                                <input type="hidden" name="_token" value="tvtnp2mVXd8pddzy2IANE1RBBXPKhRKrJNRg7Ttx">                                            </form>
