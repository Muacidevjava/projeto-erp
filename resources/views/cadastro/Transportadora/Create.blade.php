...
@section('conteudo')
    <div class="rows">
        ...
        <div class="col-12">
            ...
            @endif
                <form
                    action="{{ isset($transportadora) ? route('transportadora.update', $transportadora->id) : route('transportadora.store') }}"
                    method="POST">
                    @csrf
                            ...
                            <div class="rows">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="razao_social" id="razao_social" required
                                        value="{{ $transportadora->razao_social ?? old('razao_social') }}" class="form-campo">
                                    @error('razao_social')
                                ...
                                <div class="col-6 mb-3" id="divFantasia">
                                    ...
                                    <input type="text" name="nome_fantasia" id="nome_fantasia"
                                        value="{{ $transportadora->nome_fantasia ?? old('nome_fantasia') }} " id="nome_fantasia"
                                        class="form-campo">
                                </div>
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="cnpj" id="cnpj"
                                        value="{{ $transportadora->cnpj ?? old('cnpj') }}" class="form-campo">
                                </div>
                                ...
                                <div class="col-3" id="div_tipo_contribuinte">
                                    ...
                                    <select class="form-campo" name="tipo_contribuinte" id="tipo_contribuinte">
                                        <option value="1"
                                            {{ ($transportadora->tipo_contribuinte ?? null) == 1 ? 'selected' : '' }}>1 -
                                            Contribuinte ICMS</option>
                                        <option value="9"
                                            {{ ($transportadora->tipo_contribuinte ?? null) == 9 ? 'selected' : '' }}>9 -
                                            Não Contribuinte</option>
                                        <option value="2"
                                            {{ ($transportadora->tipo_contribuinte ?? null) == 2 ? 'selected' : '' }}>2 -
                                ...
                                <div class="col-2 mb-3">
                                    ...
                                    <input type="text" name="rg_ie" maxlength="14" id="rg_ie"
                                        value="{{ $transportadora->rg_ie ?? old('rg_ie') }}" class="form-campo">
                                </div>
                                <div class="col-4 mb-3">
                                    <label class="text-label">Celular:</label>
                                    <input type="text" name="celular"
                                        value="{{ $transportadora->celular ?? old('celular') }}"
                                        class="form-campo mascara-celular">
                                </div>

                                <div class="col-8 mb-3">
                                    <label class="text-label">Email</label>
                                    <input type="text" name="email" value="{{ $transportadora->email ?? old('email') }}"
                                        class="form-campo">
                                </div>
                            ...
                            <div class="rows">
                                <div class="col-2 mb-3">
                                    ...
                                    <div class="input-grupo">
                                        <input type="text" value="{{ $transportadora->cep ?? old('cep') }}" name="cep"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="logradouro" id="logradouro"
                                        value="{{ $transportadora->logradouro ?? old('logradouro') }}" class="form-campo rua">
                                    @error('logradouro')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-2 mb-2">
                                    ...
                                    <input type="text" name="uf" id="uf"
                                        value="{{ $transportadora->uf ?? old('uf') }}" class="form-campo estado">
                                    @error('uf')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-3 mb-3">
                                    ...
                                    <input type="text" name="complemento" id="complemento"
                                        value="{{ $transportadora->complemento ?? old('complemento') }}" class="form-campo">
                                </div>
                                <div class="col-3 mb-3">
                                    <label class="text-label">Bairro</label>
                                    <input type="text" name="bairro" id="bairro"
                                        value="{{ $transportadora->bairro ?? old('bairro') }}" class="form-campo bairro">
                                    @error('bairro')
                                        <small class="text-danger d-block">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-4 mb-2">
                                    ...
                                    <input type="text" name="cidade" id="cidade"
                                        value="{{ $transportadora->cidade ?? old('cidade') }}" class="form-campo cidade">
                                </div>
                                <div class="col-2 mb-2">
                                    <label class="text-label">IBGE</label>
                                    <input type="text" name="ibge" id="ibge"
                                        value="{{ $transportadora->ibge ?? old('ibge') }}" class="form-campo ibge">
                                </div>
                            </div>
                        </div>
                    </div>
